...
def make_now_playing_embed(cog):
    return importlib.import_module("TidalPlayerExp.ui.embeds").make_now_playing_embed


@pytest.fixture()
def make_queue_embed(cog):
    return importlib.import_module("TidalPlayerExp.ui.embeds").make_queue_embed
