...
class WeaponWorkbookValidationTests(unittest.TestCase):
    ...
    def test_validation_rejects_invalid_required_row_shapes_and_statistics(self):
        cases = {
            ...
            "negative damage": (active_row("Blade", **{"Base Damage": "-20"}),),
            "negative endlag": (active_row("Blade", Endlag="-0.5"),),
            "overflowing damage": (active_row("Blade", **{"Base Damage": "9" * 400}),),
            "overflowing speed": (active_row("Blade", **{"Swing Speed": "9" * 400}),),
            "overflowing endlag": (active_row("Blade", Endlag="9" * 400),),
