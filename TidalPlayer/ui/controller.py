...
class PlayerControllerView(discord.ui.View):
    ...
    @discord.ui.button(emoji="â¸ï¸", style=discord.ButtonStyle.primary, custom_id="tidalplayer:pause", row=0)
    ...
    @discord.ui.button(emoji="â¹ï¸", style=discord.ButtonStyle.danger, custom_id="tidalplayer:stop", row=0)
