...
class Messages:
    ...
    ERROR_STILL_LOADING = "â³ TidalPlayer is still initializing, please wait a moment."
    ...
    ERROR_NO_SPOTIFY = (
        ...
        "`[p]set api spotify client_id, client_secret,`"
    )
    ERROR_NO_YOUTUBE = "YouTube not configured. Set credentials with: `[p]set api youtube api_key,`"
